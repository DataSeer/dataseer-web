  ...
  let app = new Vue({
    ...
    data: {
      ...
      search: {
        schema: {
          ...
          roles: { dependency: `roles`, typeof: `object`, key: `_id` },
          organizations: { dependency: `organizations`, typeof: `object`, key: `_id` },
          visibleStates: { dependency: `visible`, typeof: `object`, key: `value` },
          disabledStates: { dependency: `disabled`, typeof: `object`, key: `value` },
          sort: {}
        },
        default: {
          limit: CONF.default.params.search.accounts.limit,
          skip: CONF.default.params.search.accounts.skip,
          sort: CONF.default.params.search.accounts.sort
        },
        properties: {
          limit: undefined,
          skip: undefined,
          roles: [], // Will be initialized with API
      ...
      collection: {
        ...
        dependencies: {
          ...
          disabled: [{ value: true }, { value: false }],
      ...
      newItem: {
        ...
        default: {
          ...
          role: CONF.default.role,
          visible: CONF.default.properties.accounts.visible,
          disabled: CONF.default.properties.accounts.disabled
        },
        properties: {
          username: ``,
          password: ``,
    ...
    methods: {
        ...
        return API.updateMany(ROUTES.main, opts, function (err, query) {
          ...
          query.res.map(function (subQuery) {
            ...
            return self.notifications.push(
              NOTIFICATIONS.create(self.notifications, {
                kind: NOTIFICATIONS.kinds.success,
                message: `<a href="${url}" target="_blank">${subQuery.res.username}</a> has been updated!`,
                autoclose: true
              })
            );
          });
        ...
        return API.deleteMany(ROUTES.main, opts, function (err, query) {
          ...
          query.res.map(function (subQuery) {
            ...
            return self.notifications.push(
              NOTIFICATIONS.create(self.notifications, {
                kind: NOTIFICATIONS.kinds.success,
                message: `<a href="${url}" target="_blank">${subQuery.res.username}</a> has been deleted!`,
                autoclose: true
              })
            );
          });
      ...
      add: function (event) {
        ...
        API.add(ROUTES.main, opts, function (err, query) {
          ...
          return self.notifications.push(
            ...
            NOTIFICATIONS.create(self.notifications, {
              kind: NOTIFICATIONS.kinds.success,
              message: `<a href="${url}" target="_blank">${query.res.username}</a> has been created!`,
              autoclose: true
            })
          );
        });
      ...
      copyURL: function (event) {
        ...
        let url = URLMANAGER.buildURL(`backoffice/${ROUTES.main}`, { ids: ids });
      ...
      getCurrentURLParams: function () {
        ...
        return {
          ...
          roles: PARAMS.convertToArray(urlParams.roles, `string`),
          ...
          disabledStates: PARAMS.convertToArray(urlParams.disabledStates, `boolean`),
            ...
            function (next) {
              return API.all(ROUTES.dependencies.roles, {}, function (err, query) {
                ...
                query.res.sort(DATAHANDLER.array.sortRoles).map(function (item) {
                  ...
                  self.search.properties.roles.push(
                    Object.assign(
                      {
                        selected: Array.isArray(currentParams.roles) ? currentParams.roles.indexOf(item._id) > -1 : true
                      },
                      item
                    )
                  );
