  ...
  let app = new Vue({
    ...
    data: {
      ...
      search: {
        ...
        default: {
          limit: CONF.default.params.search.organizations.limit,
          skip: CONF.default.params.search.organizations.skip,
          sort: CONF.default.params.search.organizations.sort
        },
        properties: {
          limit: undefined,
          skip: undefined,
      ...
      newItem: {
        ...
        default: {
          visible: CONF.default.properties.organizations.visible
        },
        properties: {
          name: ``,
          visible: CONF.default.properties.organizations.visible
      ...
      deleteItem: function (event) {
        ...
        return API.delete(ROUTES.main, opts, function (err, query) {
          ...
          return self.notifications.push(
            NOTIFICATIONS.create(self.notifications, {
              kind: NOTIFICATIONS.kinds.success,
              message: `<a href="${url}" target="_blank">${res.name}</a> has been deleted!`,
              autoclose: true
            })
          );
        });
