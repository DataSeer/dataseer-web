...
Self.fillDetailedReportASAPSheet = function (opts = {}, cb) {
  ...
  let batches = [
    // protocols
    {
      row: { min: 148, max: 148, insert: 148 },
      cells: [],
      data: [
        {
          merges: [
        ...
        },
        {
          ...
          data: protocols
            .filter(function (item) {
              return item.reuse && !item.issue && (item.DOI === `` || !Params.isURL(item.DOI));
            })
            .map(function (item) {
              return {
                reuse: item.reuse,
        ...
        },
        {
          ...
          data: protocols
            .filter(function (item) {
              return !item.issue && (item.DOI !== `` || Params.isURL(item.DOI));
            })
            .map(function (item) {
              return {
                reuse: item.reuse,
    ...
    // lab materials
    {
      row: { min: 108, max: 108, insert: 108 },
      cells: [],
      data: [
        {
          merges: [
      ...
      data: [
        ...
        },
        {
          ...
          data: softwares
            .filter(function (item) {
              return (
                (item.reuse && !item.RRID && !item.DOI && !item.issue) ||
                (item.reuse && !item.RRID && !item.qc && !item.issue)
              );
            })
            .map(function (item) {
              return {
        ...
        },
        {
          ...
          data: softwares
            .filter(function (item) {
              return (
                (item.RRID && !item.qc && !item.issue) ||
                (item.RRID && !item.issue && !item.DOI) ||
                (item.reuse && !item.RRID && item.qc && !item.issue && item.DOI)
              );
            })
            .map(function (item) {
              return {
        ...
        },
        {
          ...
          data: softwares
            .filter(function (item) {
              return item.RRID && item.qc && !item.issue && item.DOI;
            })
            .map(function (item) {
              return {
                reuse: item.reuse,
      ...
      data: [
        {
          ...
          data: datasets
            .filter(function (item) {
              return !item.reuse && !item.DOI && !item.qc && !item.representativeImage && !item.issue;
            })
            .map(function (item) {
              return {
                reuse: item.reuse,
        ...
        },
        {
          ...
          data: datasets
            .filter(function (item) {
              return (
                (item.DOI && !item.qc && !item.issue) ||
                (item.DOI && item.representativeImage && !item.issue) ||
                (item.DOI && item.reuse && !item.issue)
              );
            })
            .map(function (item) {
              return {
        ...
        },
        {
          ...
          data: datasets
            .filter(function (item) {
              return item.representativeImage || item.qc;
            })
            .map(function (item) {
              return {
                reuse: item.reuse,
