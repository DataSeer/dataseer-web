...
Self.fillComplianceReportDataSeerGenericPart = function (opts = {}, cb) {
  ...
  let batches = [
    // protocols
    {
      ...
      cells: [],
      params: {
        noDataRow: { min: 139, max: 141, display: true }
      },
      fn: function (batch) {
    ...
    // lab materials
    {
      ...
      cells: [],
      params: {
        noDataRow: { min: 105, max: 107, display: true }
      },
      fn: function (batch) {
        let link = `#gid=${sheetId}&range=B${batch.row.insert}`;
    ...
    // software
    {
      ...
      cells: [],
      params: {
        noDataRow: { min: 83, max: 85, display: false }
      },
      fn: function (batch) {
        let link = `#gid=${sheetId}&range=B${batch.row.insert}`;
        let label = `Software`;
    ...
    // code
    {
      ...
      cells: [],
      params: {
        noDataRow: { min: 61, max: 63, display: false }
      },
      fn: function (batch) {
        let link = `#gid=${sheetId}&range=B${batch.row.insert}`;
        let label = `Code`;
    ...
    // datasets
    {
      ...
      cells: [],
      params: {
        noDataRow: { min: 21, max: 23, display: false }
      },
      fn: function (batch) {
        let link = `#gid=${sheetId}&range=B${batch.row.insert}`;
        let label = `Datasets`;
