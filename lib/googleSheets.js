  ...
  let dataObjects = {
    ...
    'code': [
      sections[`code`].filter(function (item) {
        return !item.optional && !item.issues && !item.reuse && !item.URL && !item.DOI;
      }),
      sections[`code`].filter(function (item) {
        return !item.optional && !item.issues && item.reuse && !item.URL && !item.DOI;
      }),
      ...
      sections[`code`].filter(function (item) {
        return !item.optional && !item.issues && (item.URL || item.DOI);
      }),
      sections[`code`].filter(function (item) {
        return item.optional && !item.issues;
      })
    ],
    'software': [
      sections[`software`].filter(function (item) {
        return !item.optional && !item.issues && !item.reuse && !item.URL && !item.RRID;
      }),
      sections[`software`].filter(function (item) {
        return !item.optional && !item.issues && item.reuse && !item.URL && !item.RRID;
      }),
      ...
      sections[`software`].filter(function (item) {
        return !item.optional && !item.issues && (item.URL || item.RRID);
      }),
      sections[`software`].filter(function (item) {
        return item.optional && !item.issues;
      })
