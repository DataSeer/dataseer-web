...
Self.fillResearchOutputAvailabilityStatementAndOtherInformationASAPPart = function (opts = {}, cb) {
  ...
  let actions = [
    ...
    function (next) {
      ...
      let lastLinesStartIndex = 39 + animalModels.length - 1 + cellLines.length - 1 + 6;
      let deleteOffsetOfSections = [
        ...
        Self.buildRequestDeleteRows(sheetId, lastLinesStartIndex, lastLinesStartIndex + 8 + lines.all.length) // Delete last lines
      ];
