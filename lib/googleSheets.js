  ...
  let dataObjects = {
    'Antibodies': [
      sections[`Antibodies`].filter(function (item) {
        return !item.issues && !item.RRID && !item.catalogNumber;
      }),
      sections[`Antibodies`].filter(function (item) {
        return item.issues;
      }),
    ...
    'datasets': [
      sections[`datasets`].filter(function (item) {
        return !item.issues && !item.reuse && !item.URL && !item.DOI;
      }),
      sections[`datasets`].filter(function (item) {
        return !item.issues && item.reuse && !item.URL && !item.DOI;
      }),
      ...
      sections[`datasets`].filter(function (item) {
        return !item.issues && (item.URL || item.DOI) && !item.qc && !item.representativeImage;
      }),
      sections[`datasets`].filter(function (item) {
        return !item.issues && (item.URL || item.DOI) && (item.qc || item.representativeImage);
      })
...
Self.fillDataObjectsMDARReportPart = function (opts = {}, cb) {
  ...
  let batches = [
    // code (Code availability)
    {
      ...
      row: { min: 176, max: 176, insert: 176 },
      cells: [],
      params: {
        noDataRow: {
          min: 177,
      ...
      data: [
        {
          merges: [],
          row: { min: 179, max: 183, insert: 182 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `DOI` },
            { column: `D`, property: `URL` },
            { column: `E`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 184, max: 188, insert: 187 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `DOI` },
        ...
        {
          merges: [],
          row: { min: 189, max: 192, insert: 191 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `DOI` },
        ...
        {
          merges: [],
          row: { min: 193, max: 196, insert: 195 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `DOI` },
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 151, max: 151, insert: 151 },
      cells: [],
      params: {
        noDataRow: {
          min: 152,
      ...
      data: [
        {
          merges: [],
          row: { min: 154, max: 158, insert: 157 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `PID` },
            { column: `D`, property: `URL` },
            { column: `E`, property: `pageNumber` },
            { column: `F`, property: `notes` }
          ],
        ...
        {
          merges: [],
          row: { min: 159, max: 163, insert: 162 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `PID` },
        ...
        {
          merges: [],
          row: { min: 164, max: 167, insert: 166 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `PID` },
        ...
        {
          merges: [],
          row: { min: 168, max: 171, insert: 170 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `PID` },
        ...
        {
          merges: [],
          row: { min: 172, max: 175, insert: 174 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `PID` },
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 132, max: 132, insert: 132 },
      cells: [],
      params: { noDataRow: { display: true } },
      data: [
        {
          merges: [{ begin: 2, end: 4 }],
          row: { min: 133, max: 133, insert: 133 },
          cells: [
            { column: `B`, property: `details` },
            { column: `E`, property: `pageNumber` },
            { column: `F`, property: `notes` }
          ],
        ...
        {
          merges: [{ begin: 2, end: 4 }],
          row: { min: 134, max: 134, insert: 134 },
          cells: [
            { column: `B`, property: `details` },
            { column: `E`, property: `pageNumber` },
            { column: `F`, property: `notes` }
        ...
        {
          merges: [{ begin: 2, end: 4 }],
          row: { min: 135, max: 135, insert: 135 },
          cells: [
            { column: `B`, property: `details` },
            { column: `E`, property: `pageNumber` },
            { column: `F`, property: `notes` }
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 114, max: 114, insert: 114 },
      cells: [],
      params: {
        noDataRow: {
          min: 115,
      ...
      data: [
        {
          merges: [],
          row: { min: 117, max: 120, insert: 119 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `citation` },
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 107, max: 107, insert: 107 },
      cells: [],
      params: {
        noDataRow: { min: 108, max: 109, display: conf.settings.displayNoDataSection[`MDAR Report`][`Study Protocol`] }
      },
      data: [
        {
          merges: [],
          row: { min: 110, max: 113, insert: 112 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `citation` },
    ...
    // Human research participants
    {
      ...
      data: [
        ...
        {
          merges: [],
          row: { min: 100, max: 104, insert: 102 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `PID` },
    ...
    // Plants and microbes
    {
      ...
      data: [
        {
          merges: [],
          row: { min: 76, max: 80, insert: 79 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `source` },
            { column: `D`, property: `identifier` },
            { column: `E`, property: `pageNumber` },
            { column: `F`, property: `notes` }
          ],
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 41, max: 41, insert: 41 },
      cells: [],
      params: {
        noDataRow: { min: 42, max: 43, display: conf.settings.displayNoDataSection[`MDAR Report`][`Cell materials`] }
      },
      data: [
        {
          merges: [],
          row: { min: 44, max: 48, insert: 47 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `source` },
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 11, max: 11, insert: 11 },
      cells: [],
      params: {
        noDataRow: { min: 12, max: 13, display: conf.settings.displayNoDataSection[`MDAR Report`][`Antibodies`] }
      },
      data: [
        {
          merges: [],
          row: { min: 14, max: 17, insert: 16 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `source` },
