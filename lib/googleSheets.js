...
Self.fillComplianceReportAmNatSheet = function (opts = {}, cb) {
  ...
  let actions = [
    ...
    function (next) {
      console.log(`articleTitle`, typeof articleTitle, articleTitle);
      console.log(`dataSeerLink`, typeof dataSeerLink, dataSeerLink);
      console.log(`authors`, typeof authors, authors);
      let date = new Date();
      let data = [
      ...
      for (let i = keys.length - 1; i >= 0; i--) {
        ...
        for (let j = 0; j < infos.list.length; j++) {
          ...
          data.push(
            Self.buildRequestUpdateCell(`'Compliance Report'!E${rowIndex}`, [
