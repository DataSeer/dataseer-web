...
Self.buildDataForMDARReportSheets = function (data) {
  let sections = {
    ...
    'Laboratory Protocol': data.protocols.filter(function (item) {
      return item.dataType === `protocol` && item.subType === `published protocol`;
    }),
  ...
  let dataObjects = {
    'Antibodies': [
      sections[`Antibodies`].filter(function (item) {
        return !item.optional && !item.reuse && !item.issues && !item.RRID && !item.catalogNumber;
      }),
      sections[`Antibodies`].filter(function (item) {
        return !item.optional && item.reuse && !item.issues && !item.RRID && !item.catalogNumber;
      }),
      ...
      sections[`Antibodies`].filter(function (item) {
        return !item.optional && !item.issues && (item.RRID || item.catalogNumber);
      }),
      sections[`Antibodies`].filter(function (item) {
    ...
    'Study Protocol': [
      sections[`Study Protocol`].filter(function (item) {
        return !item.issues && (item.URL || item.DOI);
      })
    ],
    'Laboratory Protocol': [
    ...
    'datasets': [
      sections[`datasets`].filter(function (item) {
        return !item.issues && !item.reuse && !item.URL && !item.PID && !item.qc && !item.representativeImage;
      }),
      sections[`datasets`].filter(function (item) {
        return !item.issues && item.reuse && !item.URL && !item.PID && !item.qc && !item.representativeImage;
      }),
      ...
      sections[`datasets`].filter(function (item) {
        return !item.issues && (item.qc || item.representativeImage);
      })
    ],
    'code': [
...
Self.fillDataObjectsMDARReportPart = function (opts = {}, cb) {
  ...
  let batches = [
    // software (Software availability)
    {
      ...
      row: { min: 268, max: 268, insert: 268 },
      cells: [],
      params: {
        noDataRow: {
          min: 269,
      ...
      data: [
        {
          merges: [],
          row: { min: 271, max: 275, insert: 274 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 276, max: 280, insert: 279 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 281, max: 285, insert: 284 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 286, max: 290, insert: 289 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 291, max: 297, insert: 294 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 240, max: 240, insert: 240 },
      cells: [],
      params: {
        noDataRow: {
          min: 241,
      ...
      data: [
        {
          merges: [],
          row: { min: 243, max: 247, insert: 246 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 248, max: 252, insert: 251 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 253, max: 257, insert: 256 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 258, max: 262, insert: 261 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 263, max: 267, insert: 266 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 212, max: 212, insert: 212 },
      cells: [],
      params: {
        noDataRow: {
          min: 213,
      ...
      data: [
        {
          merges: [],
          row: { min: 215, max: 219, insert: 218 },
          cells: [
        ...
        {
          merges: [],
          row: { min: 220, max: 224, insert: 223 },
          cells: [
            { column: `A`, property: `dataType` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 225, max: 229, insert: 228 },
          cells: [
            { column: `A`, property: `dataType` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 230, max: 234, insert: 233 },
          cells: [
            { column: `A`, property: `dataType` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 235, max: 239, insert: 238 },
          cells: [
            { column: `A`, property: `dataType` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 206, max: 206, insert: 206 },
      cells: [],
      params: { noDataRow: { display: true } },
      data: [
        {
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 192, max: 192, insert: 192 },
      cells: [],
      params: {
        noDataRow: {
          min: 193,
      ...
      data: [
        {
          ...
          row: { min: 195, max: 199, insert: 198 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 184, max: 184, insert: 184 },
      cells: [],
      params: {
        noDataRow: { min: 185, max: 186, display: conf.settings.displayNoDataSection[`MDAR Report`][`Study Protocol`] }
      },
      data: [
        {
          merges: [{ begin: 3, end: 6 }],
          row: { min: 187, max: 191, insert: 190 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
    ...
    // Human research participants
    {
      ...
      data: [
        {
          merges: [],
          row: { min: 157, max: 161, insert: 160 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 162, max: 166, insert: 165 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 167, max: 171, insert: 170 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 172, max: 176, insert: 175 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 177, max: 182, insert: 180 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 126, max: 126, insert: 126 },
      cells: [],
      params: {
        noDataRow: {
          min: 127,
      ...
      data: [
        {
          merges: [],
          row: { min: 129, max: 133, insert: 132 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 134, max: 138, insert: 137 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 139, max: 143, insert: 142 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 144, max: 148, insert: 147 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 149, max: 153, insert: 152 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
    ...
    // Experimental animals
    {
      ...
      data: [
        {
          merges: [],
          row: { min: 101, max: 105, insert: 104 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 106, max: 110, insert: 109 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 111, max: 115, insert: 114 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 116, max: 120, insert: 119 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
        ...
        {
          merges: [],
          row: { min: 121, max: 125, insert: 124 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 70, max: 70, insert: 70 },
      cells: [],
      params: {
        noDataRow: { min: 71, max: 72, display: conf.settings.displayNoDataSection[`MDAR Report`][`Cell materials`] }
      },
      data: [
        {
          merges: [],
          row: { min: 73, max: 77, insert: 76 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
    ...
    {
      sheet: { id: sheetId, name: sheetName },
      row: { min: 14, max: 14, insert: 14 },
      cells: [],
      params: {
        noDataRow: { min: 15, max: 16, display: conf.settings.displayNoDataSection[`MDAR Report`][`Antibodies`] }
      },
      data: [
        {
          merges: [],
          row: { min: 17, max: 21, insert: 20 },
          cells: [
            { column: `A`, property: `name` },
            { column: `B`, property: `sentences` },
            { column: `C`, property: `pageNumber` },
  ...
  let actions = [
    ...
    function (next) {
      ...
      let data = [
        ...
        Self.buildRequestUpdateCell(`'${sheetName}'!B4`, [MAS])
      ];
      return gSheets.spreadsheets.values.batchUpdate(
        {
          // The ID of the spreadsheet to update.
