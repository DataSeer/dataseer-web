      ...
      let actions = [
        ...
        function (n) {
          ...
          if (noData) {
            ...
            requests.push(Self.buildRequestDeleteSheet(batch.sheet.id));
          }
          return gSheets.spreadsheets.batchUpdate(
            {
              // The ID of the spreadsheet to update.
        ...
        data.push(
          Self.buildRequestUpdateCell(`'Authors and Affiliation'!E${rowIndex}`, [
            `=SI(C${10 + i}, IFNA(IFS(ESTTEXTE(RECHERCHEV(REGEXEXTRACT($A${
              ...
              10 + i
            }, "([à-üÀ-ÜA-Za-z-\s]+)[\s0-9,#&^]"), Authors!$B$2:$I, 8, FAUX), EXACT(IFNA(RECHERCHEV(REGEXEXTRACT($A${
              10 + i
            },"[à-üÀ-ÜA-Za-z-]+"), Authors!$C$2:$I, 7, FAUX), "N/A"), IFNA(RECHERCHEV(REGEXEXTRACT($A${
              10 + i
            }, "([à-üÀ-ÜA-Za-z-]+)[\s0-9,#&^]$"), Authors!$D$2:$I, 6, FAUX), "N/A-2")), RECHERCHEV(REGEXEXTRACT($A${
              10 + i
            }, "[à-üÀ-ÜA-Za-z-]+"), Authors!$C$2:$I, 7, FAUX), EXACT(IFNA(RECHERCHEV(REGEXEXTRACT($A${
              10 + i
            },"[à-üÀ-ÜA-Za-z-]+"), Authors!$D$2:$I, 6, FAUX), "N/A"), IFNA(RECHERCHEV(SUPPRESPACE(REGEXEXTRACT($A${
              10 + i
            }, "([à-üÀ-ÜA-Za-z-]+)[\s0-9,#&^]$")), Authors!$C$2:$I, 7, FAUX), "N/A-2")), RECHERCHEV(REGEXEXTRACT($A${
              10 + i
            }, "[à-üÀ-ÜA-Za-z-]+"), Authors!$D$2:$I, 6, FAUX)), "Not Found"), "")`
          ])
        );
      }
      return gSheets.spreadsheets.values.batchUpdate(
