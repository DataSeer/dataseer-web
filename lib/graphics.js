...
const graphicsConf = require(`../conf/graphics.json`);
...
Self.buildRenderedASAPPie = function (opts = {}, cb) {
  ...
  if (
    ...
    opts.render.type = graphicsConf.render.type;
  if (
    ...
    opts.render.quality = graphicsConf.render.quality;
  if (
    ...
    opts.render.width = graphicsConf.render.width;
  if (
    ...
    opts.render.height = graphicsConf.render.height;
  (async () => {
