  ...
  'TEI': {
    ...
    'metadata': {
      ...
      'author_persons': function($) {
        return $('TEI > teiHeader > fileDesc > sourceDesc > biblStruct > monogr > author > persName').text();
      },
      'author_organizations': function($) {
        return $('TEI > teiHeader > fileDesc > sourceDesc > biblStruct > monogr > author > affiliation > orgName')
          .map(function(i, el) {
            return $(el).text();
          })
          .get();
