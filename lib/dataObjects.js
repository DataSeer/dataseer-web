...
Self.create = function (opts = {}, autoPopulate = false) {
  ...
  let result = {
    ...
    qc: Params.convertToBoolean(dataObject.qc) ? true : false, // dataset qc
    representativeImage: Params.convertToBoolean(dataObject.representativeImage) ? true : false, // dataset representativeImage
    issues: typeof dataObject.issues === `object` ? dataObject.issues : null, // dataset issues
    flagged: Params.convertToBoolean(dataObject.flagged) ? true : false, // dataset flagged
