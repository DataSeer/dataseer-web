...
Self.searchEntity = function (opts, cb) {
  ...
  if (opts.kind === `software` || opts.kind === `code`) {
    ...
    URLs.searchAntibody = URLMANAGER.build(service.searchTool, { q: opts.entity, l: opts.entity }, service.root);
    URLs.searchPlasmid = URLMANAGER.build(service.searchTool, { q: opts.entity, l: opts.entity }, service.root);
    URLs.searchOrganism = URLMANAGER.build(service.searchTool, { q: opts.entity, l: opts.entity }, service.root);
    URLs.searchCellLine = URLMANAGER.build(service.searchTool, { q: opts.entity, l: opts.entity }, service.root);
